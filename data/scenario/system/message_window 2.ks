;メッセージレイヤの定義
		...
		[position width=1040 height=350 top=1500 left=50 ]
		...
		[ptext name="chara_name_area" layer="message0" color=0xFFFFFF size=26 x=30 y=1123 bold="bold" edge="undefined" shadow="undefined"]
		...
		[position layer="message1" width=1040 height=350 top=1500 left=50 ]
